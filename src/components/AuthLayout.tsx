...
const AuthLayout = ({ children }: AuthLayoutProps) => {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[hsl(210_55%_6%)]" dir={isRTL ? 'rtl' : 'ltr'}>
      {/* ============ FULL-SCREEN BACKGROUND: REFERENCE IMAGE ============ */}
      <div className="absolute inset-0">
        {/* Base dark fill matching reference tone */}
        <div className="absolute inset-0 bg-[hsl(200_45%_8%)]" />
        ...
        {/* Subtle dark overlay for form legibility */}
        <div className="pointer-events-none absolute inset-0 bg-[hsl(210_55%_4%)]/20" />

        {/* Top + bottom vignette */}
        <div className="pointer-events-none absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-[hsl(210_55%_4%)]/70 to-transparent" />
        <div className="pointer-events-none absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-[hsl(210_55%_4%)]/70 to-transparent" />
      </div>
